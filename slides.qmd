...
![](https://media.giphy.com/media/WWasEv3MSNtio/giphy.gif?cid=790b76114pvukzevehohsjky11wz43u4qwzuwlnqy3jvv1ww&ep=v1_gifs_search&rid=giphy.gif&ct=g){fig-alt="Image of a meer cat looking around with googly eyes." fig-align=center width=70% height=70%}
...
![](images/3-times.png){fig-alt="text" fig-align=center width=70% height=70%}
...
![](images/bcgov-github-landing-2024.png){fig-alt="bcgov GitHub web page screen shot from 2021." fig-align="center" width=80% height=80%}
