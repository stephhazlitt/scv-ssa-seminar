...
![](images/bcdc.png){fig-alt="text" fig-align=center}

## bcdata 📦

![](images/bcdata.png){fig-alt="text" fig-align=center}
...
bcdata::bcdc_query_geodata(record = "bc-airports") |>
  ...
  geom_sf() +
  geom_sf(
    data = bcmaps::census_division() |> filter(CENSUS_DIVISION_NAME == "Capital"),
    fill = NA
  ) 
```
...
![](images/VicmapR.png){fig-alt="VicmapR package screen shot." fig-align="center"}
...
## Find People Through Communities

![](images/communities-hex.png){fig-alt="Hex sticker logos for rOpenSci and The Carpentries"}

![](https://community.rstudio.com/uploads/default/original/3X/1/4/14e196d9bc9868b7e350a697a5d411597c6e2fe6.jpeg){.absolute top=200 left=500 width=50%}


![](https://scotttalks.info/user-http/img/green_short_hexsticker.png){.absolute left=700 width=30%}

![](https://community-cdn.rstudio.com/uploads/default/original/3X/e/6/e61d5c8d76feee06efb84f95880e3fc4e12cf269.png){.absolute top=300 left=100 height=50% height=50%}
...
## Thank You Statistical Computing and Visualization Committee
...
<https://github.com/stephhazlitt/scv-ssa-seminar>
